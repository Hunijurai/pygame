...
class Ball(Block):
    ...
    def collisions(self):
        if self.rect.top <= 0 or self.rect.bottom >= screen_height:
            pygame.mixer.Sound.play(pygame.mixer.Sound("pong.ogg"))
            self.speed_y *= -1
    ...
    def reset_ball(self):
        ...
        pygame.mixer.Sound.play(pygame.mixer.Sound("score.ogg"))
    ...
    def restart_counter(self):
        ...
        pygame.draw.rect(screen, pygame.Color('#879ceb'), time_counter_rect)
...
while True:
    ...
    screen.fill(pygame.Color('#879ceb'))
